...
% max_bunny_size_for_height(+Height, +BunnyInfoProportion, +BunnyFontProportion, +Generations, -BunnySize)
...
% bunny_size_unlimited (+Height, +Width, +BunnyPlusProportion, +BunnyInfoProportion, +BunnyFontProportion, +Generations, -BunnySize)
...
% max_generations_for_height(+Height, +BunnyInfoProportion, +BunnyFontProportion, +BunnySize, -Generations)
...
% generations (+Height, +Width, +BunnyPlusProportion, +BunnyInfoProportion, +BunnyFontProportion, +BunnySize, -Generations)
